    ...
    private function getPatientData()
    {
        ...
        $this->patient_data = [
            ...
            'DateMonth' => [
                ...
                'family' => 'Arial',
                'style' => '',
                'value' => $this->patient->created_at->setTimezone('America/Los_Angeles')->format('m'),
            ],
            'DateDay' => [
                'size' => 9,
                'family' => 'Arial',
                'style' => '',
                'value' => $this->patient->created_at->setTimezone('America/Los_Angeles')->format('d'),
            ],
            'DateYear' => [
                'size' => 9,
                'family' => 'Arial',
                'style' => '',
                'value' => $this->patient->created_at->setTimezone('America/Los_Angeles')->format('y'),
            ],
            'DateTime' => [
                'size' => 9,
                'family' => 'Arial',
                'style' => '',
                'value' => $this->patient->created_at->setTimezone('America/Los_Angeles')->format('H:i'),
            ],
            'BirthMonth' => [
                'size' => 9,
                'family' => 'Arial',
